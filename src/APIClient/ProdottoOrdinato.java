...
public class ProdottoOrdinato extends Prodotto implements Serializable {
    ...
    public ProdottoOrdinato(String nome, CategoriaProdotto categoria, float prezzo, int quantita, Date data, Azienda a, Fornitore fornitore, int quantita_ordinata) {
